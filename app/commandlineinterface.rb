class CommandLineInterface
    ...
    def greet
        puts "
    .===================================================================.
         Welcome to the Brewery finder, ready to get some beers?
     ===================================================================.
    "
        puts "
         I can help you find list of local breweries!"
        gets_user_name
        display_menu
    end 
    ...
    def update_user_name
        puts "
                            Great, what would you like me to call you instead?
                                                                            "
